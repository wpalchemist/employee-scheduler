...
Contributors: range, gwendydd, jpkay, saracannon, scubakyle, petemall
...
[youtube http://youtu.be/Gf84Rh0nBvw]

Learn more at [shiftee.co](https://shiftee.co/?utm_source=wp-org)

Upgrade to [Shiftee](https://shiftee.co/downloads/shiftee/?utm_source=wp-org) for even more features!
...
For complete documentation, visit the [Shiftee Basic Documentation](https://shiftee.co/docs/category/shiftee-basic/?utm_source=wp-org)
...
== Changelog ==
= 2.2.2 =
* bug fix: fix php error in some environments that prevented Shiftee settings and user data from being saved
