...
if ( ! class_exists( 'Shiftee_Basic' ) ) {
	...
	class Shiftee_Basic {
		...
		private function load_dependencies() {
			 ...
			 * core plugin.
			 */
			require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic-loader.php';

			/**
			 * The class containing functions and variables used throughout the plugin.
			 */
			require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-helper.php';

			/**
			 * The class responsible for defining internationalization functionality
			 * of the plugin.
			 */
			require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic-i18n.php';

			/**
			 * The class responsible for updates
			 */
			require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic-updater.php';

			/**
			 * The class responsible for defining all actions that occur in the admin area.
			 */
			require_once SHIFTEE_BASIC_DIR . '/admin/class-shiftee-basic-admin.php';

			/**
			 * The class responsible for the options page.
			 */
			require_once SHIFTEE_BASIC_DIR . '/admin/class-shiftee-basic-options.php';

			/**
			 * The class responsible for defining all actions that occur in the public-facing
			 * side of the site.
			 */
			require_once SHIFTEE_BASIC_DIR . '/public/class-shiftee-basic-public.php';

			/**
			 * The class responsible for sending emails.
			 */
			require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-email.php';
		...
		private function define_admin_hooks() {
			...
			if ( file_exists( SHIFTEE_BASIC_DIR . '/libraries/cmb2/init.php' ) ) {
				require_once SHIFTEE_BASIC_DIR . '/libraries/cmb2/init.php';
			}
			...
			$this->loader->add_filter( 'manage_edit-shift_sortable_columns', $plugin_admin, 'shift_sortable_columns' );
			$this->loader->add_action( 'pre_get_posts', $plugin_admin, 'order_shifts_by_date', 1 );
			...
			$this->loader->add_action( 'shiftee_clock_in_action', $plugin_admin, 'clock_in_notification', 10, 2 );
