...
define( 'SHIFTEE_BASIC_DIR', plugin_dir_path( __FILE__ ) );
define( 'SHIFTEE_BASIC_DIR_URL', plugin_dir_url( __FILE__ ) );

/**
 * The code that runs during plugin activation.
 */
function activate_shiftee_basic() {
	require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic-activator.php';
...
function deactivate_shiftee_basic() {
	require_once SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic-deactivator.php';
 ...
 */
require SHIFTEE_BASIC_DIR . '/includes/class-shiftee-basic.php';
...
function shiftee_load_admin() {
	P2P_Autoload::register( 'P2P_', SHIFTEE_BASIC_DIR . '/libraries/wpp2p/admin' );
...
require SHIFTEE_BASIC_DIR . '/libraries/wpp2p/scb/load.php';
