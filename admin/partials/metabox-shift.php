...
<table class="form-table">
	...
	<tr>
		...
		<td>
			...
			<?php
			if ( $metabox->get_the_value( 'starttime' ) && $metabox->get_the_value( 'starttime' ) !== '____-__-__' && $metabox->get_the_value( 'endtime' ) && $metabox->get_the_value( 'endtime' ) !== '____-__-__' ) {
	...
	<tr>
		...
		<td>
			...
			<?php
			if ( $metabox->get_the_value( 'clockin' ) && $metabox->get_the_value( 'clockin' ) !== '____-__-__' && $metabox->get_the_value( 'clockout' ) && $metabox->get_the_value( 'clockout' ) !== '____-__-__' ) {
	...
	<?php
	$options = get_option( 'wpaesm_options' ); // display geolocation information if option is set
	...
	<tr>
		...
		<td>
			...
			<input type="checkbox" name="<?php $metabox->the_name(); ?>" value="1"
																	 <?php
																		if ( $metabox->get_the_value() ) {
																			echo ' checked="checked"';}
																		?>
			/><?php _e( ' Notify Employee', 'wpaesm' ); ?>
		</td>
	</tr>
