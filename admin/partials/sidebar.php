 ...
 * Sidebar
 *
 * Sidebar to display on Shiftee admin pages.
 *
 * @link       http://ran.ge
 * @since      2.0.0
 *
 ...
 */
?>
<h3><?php _e( 'Upgrade to Shiftee!', 'employee-scheduler' ); ?></h3>
...
<h3><?php _e( 'Need help with Shiftee Basic?', 'employee-scheduler' ); ?></h3>
<p><?php _e( 'We can answer your questions on the WordPress support forum!', 'employee-scheduler' ); ?></p>
<p><a class="button button-primary" href="https://wordpress.org/support/plugin/employee-scheduler/"><?php _e( 'Get Support', 'employee-scheduler' ); ?></a>
</p>
