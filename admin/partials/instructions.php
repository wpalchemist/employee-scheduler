...
<div class="wrap instructions">
	...
	<p><?php printf( __( 'The plugin has a few settings that you might want to adjust.  In the WordPress dashboard menu, click on <a href="%1$s">%2$s.</a>', 'employee-scheduler' ), admin_url( 'admin.php?page=shiftee' ), apply_filters( 'shiftee_name', __( 'Shiftee Basic', 'employee-scheduler' ) ) ); ?></p>
